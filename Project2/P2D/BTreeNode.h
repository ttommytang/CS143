...
class BTLeafNode {
  public:
    /**
     * Constructor of BTLeafNode class, set all buffer zeros.
     * @return
     */
    BTLeafNode();
   /**
  ...
  private:
    ...
    */
    ...
    static const int LEAF_ENTRY_SIZE = sizeof(int) + sizeof(RecordId);
    static const int MAX_KEYS_LEAF = (PageFile::PAGE_SIZE - sizeof(PageId)-sizeof(int))/LEAF_ENTRY_SIZE;
}; 
...
class BTNonLeafNode {
  public:
    /*
     * Default constructor for the BTNonLeafNode class, set buffer all zeros.
     */
    BTNonLeafNode();
   /**
  ...
  private:
    ...
    */
    char buffer[PageFile::PAGE_SIZE];
    /**
     * Two constant to define the entry size and the max entry numbers
     * in the non-leaf nodes.
     */
    static const int NONLEAF_ENTRY_SIZE = 2 * sizeof(int);
    static const int NONLEAF_ENTRY_NUM = (PageFile::PAGE_SIZE - sizeof(int) - sizeof(PageId))/NONLEAF_ENTRY_SIZE;
}; 
