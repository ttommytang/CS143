...
class BTreeIndex {
 public:
   ...
   * */
  RC insertRec(int key, const RecordId& rid, PageId& curPid, int& upKey, PageId& upPid, int height);
   ...
   *                       to read and search.
   */
  RC locateRec(int searchKey, IndexCursor& cursor,
                             int height, PageId curPid);
